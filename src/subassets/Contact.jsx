...
const Contact = () => {
  ...
  return (
    /**/
    <div className="h-screen w-screen bg-[#111D4A] sticky bottom-0 z-50 overflow-hidden">
      <div className="flex flex-col gap-10 justify-start pt-[15%] sm:pt-[10%] items-center h-screen w-screen bg-[#1E1E24] z-40">
        <span>
          <motion.h1
            initial={{ opacity: 0 }}
            whileInView={{
